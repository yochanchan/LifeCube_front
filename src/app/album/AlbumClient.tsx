...
export default function AlbumClient({
  ...
  // 写真一覧
  const picsKey = selectedDate ? endpoints.byDate(selectedDate, accountId, tripId, 256) : null;
  const {
    data: pictures = initial.pictures,
    error: errorPics,
    isLoading: loadingPics,
  } = useSWR<PictureMeta[]>(picsKey, fetcher, { fallbackData: initial.pictures });
