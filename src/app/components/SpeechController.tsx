...
function matchKeyword(text: string): string | null {
  ...
  const rules: { keyword: string; re: RegExp }[] = [
    ...
    { keyword: "すごい/最高", re: /(すごい|すげー|やばい|最高|すばらしい|素晴らしい|ぜっけい)/ }, // ← 250821追加
    { keyword: "きれい/美しい", re: /(きれい|うつくしい)/ }, // ← 250821追加
    { keyword: "見て/発見", re: /(みて|あれ|なにあれ|おもしろい|めずらしい)/ }, // ← 250821追加
    { keyword: "かわいい", re: /(かわいい|かわいー|ねがお)/ }, // ← 250821追加
    { keyword: "驚き/感嘆", re: /(うわ|うわー|おー|おお|まじで)/ }, // ← 250821追加
    { keyword: "楽しい/面白い", re: /(たのしい|うける|わらった|えがお)/ }, // ← 250821追加
    { keyword: "大きい", re: /(おおきい|でかい|でっかい)/ }, // ← 250821追加
  ];
