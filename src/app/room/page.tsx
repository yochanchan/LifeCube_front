        ...
        <div className="mx-auto max-w-md space-y-4">
          ...
          {!showCameraOptions ? (
            ...
            <div className="space-y-3">
              ...
              >
                <div className="w-16 h-16 rounded-full flex items-center justify中心 mx-auto mb-3" style={{ backgroundColor: '#B6A98B' }}>
              ...
              <Link href="/album" className="block">
                <div className="w-full rounded-xl bg白 p-6 text-center hover:shadow-lg transition-shadow cursor-pointer ring-1 ring-blue-200">
                  <div className="w-16 h-16 rounded-full flex items-center justify中心 mx-auto mb-3" style={{ backgroundColor: '#FCF98B' }}>
                    <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-3">
              ...
              <Link href="/shooter" className="block">
                <div className="w-full rounded-xl bg白 p-6 text-center hover:shadow-lg transition-shadow cursor-pointer ring-1 ring-blue-200">
                  <div className="w-16 h-16 rounded-full flex items-center justify中心 mx-auto mb-3" style={{ backgroundColor: '#5BD3CB' }}>
                    <svg className="w-8 h-8 text白" fill="none" stroke="currentColor" viewBox="0 0 24 24">
