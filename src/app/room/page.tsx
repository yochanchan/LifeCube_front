          ...
          <div className="space-y-3">
            ...
            <Link href="/recorder" className="block">
              <div className="w-full rounded-xl bg-white p-6 text-center hover:shadow-lg transition-shadow cursor-pointer ring-1 ring-blue-200">
                    ...
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 13a3 3 0 11-6 0 3 3 0 016 0z" />
                                 ...
                                 <span className="text-blue-600 text-sm font-medium">音声で撮る</span>
              </div>
            </Link>
            ...
            <Link href="/shooter" className="block">
              <div className="w-full rounded-xl bg-white p-6 text-center hover:shadow-lg transition-shadow cursor-pointer ring-1 ring-blue-200">
                ...
                <span className="text-blue-600 text-sm font-medium">手動で撮る</span>
              </div>
            </Link>
            ...
            <Link href="/album" className="block">
              <div className="w-full rounded-xl bg-white p-6 text-center hover:shadow-lg transition-shadow cursor-pointer ring-1 ring-blue-200">
                ...
                <span className="text-blue-600 text-sm font-medium">アルバム</span>
              </div>
            </Link>
            
            <Link href="/" className="block">
                             <button className="w-full rounded-xl bg-white px-4 py-2 font-semibold ring-1 ring-rose-200 hover:bg-rose-50" style={{ color: '#2B578A' }}>
                トップへ戻る
              </button>
            </Link>
          </div>
